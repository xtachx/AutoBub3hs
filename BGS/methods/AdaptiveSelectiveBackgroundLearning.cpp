...
{
  std::cout << "AdaptiveSelectiveBackgroundLearning has been initialized" << std::endl;
}

AdaptiveSelectiveBackgroundLearning::~AdaptiveSelectiveBackgroundLearning()
{
  std::cout << "~AdaptiveSelectiveBackgroundLearning is done. Thank you." << std::endl;
}
...
void AdaptiveSelectiveBackgroundLearning::process(const cv::Mat &img_input_, cv::Mat &img_output, cv::Mat &img_bgmodel)
{
  ...
  {
    //std::cout << "Adaptive update...C: " << counter << " | L: "<<learningFrames <<std::endl;
